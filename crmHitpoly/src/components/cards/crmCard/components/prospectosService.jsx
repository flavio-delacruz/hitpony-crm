...
const useProspectos = () => {
  ...
  // Lógica para obtener prospectos (copiada del contexto)
  ...
  // Lógica para eliminar prospectos (copiada del contexto)
  ...
  // Efecto para cargar prospectos al montar el componente o cambiar el usuario
  useEffect(() => {
    if (user?.id) {
      fetchAllProspects();
    }
